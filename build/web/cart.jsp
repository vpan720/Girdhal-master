<%-- 
    Document   : cart
    Created on : Apr 2, 2019, 9:02:24 PM
    Author     : VIKAS
--%>
            ...
            <br><table border="1" width="40%">
                ...
                <c:forEach var="row" items="${result.rows}">
                    <tr>
                        ...
                        <td><c:out value="${row.price_prkg}"/></td>
                        <td><c:out value="${row.totalprice}"/></td>
                        <td><a href="javascript:confirmGo('Sure to Delete this Record?','cartdelete.jsp?id=<c:out value="${row.id}"/>')">Delete</a></td>
                    </tr>
                </c:forEach>
            </table>
        </form><br><br>
