...
<html>
    ...
    <body>
        <c:if test="${empty param.c6}">
            <c:redirect url="product.jsp">
                <c:param name="errMsg16" value="Please Select Checkbox"/>
            </c:redirect>
        </c:if>
        <c:if test="${empty param.qty6}">
            <c:redirect url="product.jsp">
                <c:param name="errMsg17" value="Please Enter Quantity"/>
            </c:redirect>
        </c:if>
        <c:if test="${param.qty6<10}">
            <c:redirect url="product.jsp">
                <c:param name="errMsg18" value="Please Enter Valid Quantity"/>
            </c:redirect>
        </c:if>
